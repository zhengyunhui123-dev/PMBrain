...
// Source: admin/dist/ at 2026-06-19.
//
...
import A_0_assets_index_CtwMyF2l_js from '../admin/dist/assets/index-CtwMyF2l.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_e_wPqImK_css from '../admin/dist/assets/index-e_wPqImK.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-CtwMyF2l.js": { path: A_0_assets_index_CtwMyF2l_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-e_wPqImK.css": { path: A_1_assets_index_e_wPqImK_css as unknown as string, mime: "text/css; charset=utf-8" },
