...
// Source: admin/dist/ at 2026-06-27.
//
...
import A_0_assets_index_BXTtpK1l_css from '../admin/dist/assets/index-BXTtpK1l.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_CT_aqCUf_js from '../admin/dist/assets/index-CT_aqCUf.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-BXTtpK1l.css": { path: A_0_assets_index_BXTtpK1l_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-CT_aqCUf.js": { path: A_1_assets_index_CT_aqCUf_js as unknown as string, mime: "application/javascript; charset=utf-8" },
