...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_2_assets_index_CNlF7J___js from '../admin/dist/assets/index-CNlF7J--.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-CNlF7J--.js": { path: A_2_assets_index_CNlF7J___js as unknown as string, mime: "application/javascript; charset=utf-8" },
