...
// Source: admin/dist/ at 2026-08-03.
//
...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_CHdgekHv_js from '../admin/dist/assets/index-CHdgekHv.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_2_assets_index_DaHBv19a_css from '../admin/dist/assets/index-DaHBv19a.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-CHdgekHv.js": { path: A_1_assets_index_CHdgekHv_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-DaHBv19a.css": { path: A_2_assets_index_DaHBv19a_css as unknown as string, mime: "text/css; charset=utf-8" },
