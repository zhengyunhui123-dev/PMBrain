...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_BRRyo29V_css from '../admin/dist/assets/index-BRRyo29V.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_2_assets_index_DtiRJZfa_js from '../admin/dist/assets/index-DtiRJZfa.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-BRRyo29V.css": { path: A_1_assets_index_BRRyo29V_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-DtiRJZfa.js": { path: A_2_assets_index_DtiRJZfa_js as unknown as string, mime: "application/javascript; charset=utf-8" },
