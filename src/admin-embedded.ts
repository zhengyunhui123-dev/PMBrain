...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_QF_NYtPc_css from '../admin/dist/assets/index-QF_NYtPc.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_2_assets_index_sV7aZNSf_js from '../admin/dist/assets/index-sV7aZNSf.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-QF_NYtPc.css": { path: A_1_assets_index_QF_NYtPc_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-sV7aZNSf.js": { path: A_2_assets_index_sV7aZNSf_js as unknown as string, mime: "application/javascript; charset=utf-8" },
