...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_2_assets_index_BrsiqGw__js from '../admin/dist/assets/index-BrsiqGw-.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-BrsiqGw-.js": { path: A_2_assets_index_BrsiqGw__js as unknown as string, mime: "application/javascript; charset=utf-8" },
