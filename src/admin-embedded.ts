...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_BNMiXVVG_js from '../admin/dist/assets/index-BNMiXVVG.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_2_assets_index_kAG_JuGm_css from '../admin/dist/assets/index-kAG_JuGm.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-BNMiXVVG.js": { path: A_1_assets_index_BNMiXVVG_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-kAG_JuGm.css": { path: A_2_assets_index_kAG_JuGm_css as unknown as string, mime: "text/css; charset=utf-8" },
