...
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_Bg7cqF_M_css from '../admin/dist/assets/index-Bg7cqF_M.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_2_assets_index_CV6HJ24C_js from '../admin/dist/assets/index-CV6HJ24C.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_3_assets_react_LdaKN5mt_js from '../admin/dist/assets/react-LdaKN5mt.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_4_assets_ui_CFS87I1V_js from '../admin/dist/assets/ui-CFS87I1V.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  ...
  "/admin/assets/index-Bg7cqF_M.css": { path: A_1_assets_index_Bg7cqF_M_css as unknown as string, mime: "text/css; charset=utf-8" },
  "/admin/assets/index-CV6HJ24C.js": { path: A_2_assets_index_CV6HJ24C_js as unknown as string, mime: "application/javascript; charset=utf-8" },
  ...
  "/admin/assets/ui-CFS87I1V.js": { path: A_4_assets_ui_CFS87I1V_js as unknown as string, mime: "application/javascript; charset=utf-8" },
