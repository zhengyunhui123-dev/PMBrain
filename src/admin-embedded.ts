...
// Source: admin/dist/ at 2026-06-10.
//
...
import A_0_assets_index_B9Cs9SL__js from '../admin/dist/assets/index-B9Cs9SL_.js' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
import A_1_assets_index_CkGzvm___css from '../admin/dist/assets/index-CkGzvm_-.css' with { type: 'file' };
// @ts-ignore — type: 'file' is Bun ESM, not in lib.d.ts
...
export const ADMIN_ASSETS: Record<string, AdminAsset> = {
  "/admin/assets/index-B9Cs9SL_.js": { path: A_0_assets_index_B9Cs9SL__js as unknown as string, mime: "application/javascript; charset=utf-8" },
  "/admin/assets/index-CkGzvm_-.css": { path: A_1_assets_index_CkGzvm___css as unknown as string, mime: "text/css; charset=utf-8" },
