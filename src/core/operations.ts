...
import type { OperationContext, Operation } from './ops/contract.ts';
...
const think: Operation = {
  ...
  params: {
    ...
    model: { type: 'string', description: 'Model override (alias or full id). Falls through models.think → models.default / desktop ordinary model → configured tier.' },
...
export const operations: Operation[] = [
  ...
  // Ontology current-value ops (chronicle timeline reads land in a later PR)
  ...chronicleOperations,
