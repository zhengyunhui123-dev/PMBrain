...
const shape = platform === 'win32'
  ? {
      ...
      releaseManifest: join(distRoot, 'win-unpacked', 'resources', 'release-manifest.json'),
  ...
  : platform === 'darwin'
    ? {
        ...
        releaseManifest: join(distRoot, 'mac-arm64', 'PMBrain.app', 'Contents', 'Resources', 'release-manifest.json'),
    ...
    : {
        ...
        releaseManifest: join(distRoot, 'linux-unpacked', 'resources', 'release-manifest.json'),
