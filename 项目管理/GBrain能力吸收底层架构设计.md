...
| PMBrain 基线 | 设计时 Core `1.3.61` · Desktop `1.1.92` · Schema `124`；落地后本分支 Core `1.3.67`（产品栈 PR11 = 1.3.66）· Schema `130` |
...
**历史约束：** 在用户书面批准本设计之前，不开始实现。2026-09-19：已批准；PR1–PR11 已在 `execute-plan/dce9287a-pr-*` 落地；PR12 只改文档与台账。SkillOpt 与全局 basename Wikilink 仍不在范围内。

**本分支代码边界（诚实）：** 有 Connectors / Google / Open Loops / Chronicle / Ontology / 实体身份 / Advisor chronicle / Admin·Desktop 日常面。无 Memorable（sibling PR8）、无 BrainBench 语料（sibling PR10）、无 SkillOpt。

---

## Background & Motivation

### 当前状态（设计时 1.3.61 代码核实；落地后见文首「本分支代码边界」）
...
**未勾选「批准本设计」之前，不得提交实现 PR。** 2026-09-19：已勾选并实现；本文档随 PR12 入库。
